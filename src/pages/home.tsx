...
//UTILS
import { currencyConverter, hightlightTextConvert } from '@/utils'
      ...
      <Container className="mb-2" maxWidth="lg">
        <Grid container spacing={4}>
                  ...
                  {!highlightsLoading && highlightsData && (
                    <>
                      ...
                      <StyledSpan color="white">
                        {hightlightTextConvert(highlightsData[1].subtitle)}
                      </StyledSpan>
                    </>
                  )}
                </CardComponent>
          ...
          <Grid item xs={12} md={5}>
            {!salesStarsError && (
              <CardComponent
                className={salesStarsLoading ? 'skeleton-loading' : ''}
              >
          ...
          <Grid item xs={12} md={5}>
            {!newsError && (
              <CardComponent className={newsLoading ? 'skeleton-loading' : ''}>
